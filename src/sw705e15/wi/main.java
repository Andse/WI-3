...
//		SparseMatrix data = new SparseMatrix(new double[][]{
...
//		
		SparseMatrix data = MovieUserRatingParser.parserUserRatingMovies(trainingDataDirectoryPath, moviesDescriptionsFilePath, qualifyingAndPredictionFilePath, probeFilePath, trainingDataLimit)
